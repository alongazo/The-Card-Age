...
public class Board : MonoBehaviour
{
    ...
    void Update () {
        ...
        else if (Input.GetMouseButtonDown(0))
        {
            ...
            ////Debug.Log("Is my turn: " + isPlayerTurn);//" + cards[x, y].isWhite + " " + isWhiteTurn);
            ////Debug.Log("hello");
    ...
    private void SelectCard(int x, int y)
    {
        ...
        if (cards[x, y].isPlayer != isPlayerTurn)
        {
            return;
        }
    ...
    private void MoveCard(int x, int y)
    {
        ...
        {
            Card c = cards[x, y];
            if (c != null && c.isPlayer != isPlayerTurn) // for attacking
            {
                //Debug.Log("attack");
            ...
            else if (cards[x, y] == null) // for moving
            {
