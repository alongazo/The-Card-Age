...
public class Card : MonoBehaviour {
    ...
    {
        foreach (Text items in card.GetComponents<Text>())
        {
            if (items.name == "Name")
            {
                items.text = linkedPlayingCard.GetName();
            }
        }
    ...
    {
        string texture = "Assets/PlayingBoard/Card_Images/" + linkedPlayingCard.GetImage();
